...
(function () {
  ...
  var helpinfo = [
    ...
    '<tr><td>docs</em></td><td class="answer">Opens a new window with a complete set of documentation for Convolv extensions to the Mathjs library as well as all available console and charting commands.</td></tr>',
  ...
  createBaseChart = function createBaseChart(container, chartData, uoptions) {
    ...
    return Highcharts.chart(container, {
      ...
      xAxis: {
        ...
        endOnTick: options.xEndOnTic,
        startOnTick: options.xStartOnTic,
        type: options.xType,
